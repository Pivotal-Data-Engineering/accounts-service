...
public class GemfireLocalConfig {
	...
	@Bean
	LocalRegionFactoryBean<String, Account> accountRegion(final GemFireCache cache) {
		LocalRegionFactoryBean<String, Account> accountRegion = new LocalRegionFactoryBean<>();
		accountRegion.setCache(cache);
		accountRegion.setClose(false);
		accountRegion.setName("Account");
		accountRegion.setPersistent(false);
